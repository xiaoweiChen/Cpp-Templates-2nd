...
\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
	...
	\begin{center}
		...
		\\[8pt]
		\normalsize
		译者：\href{https://github.com/Walton1128}{Walton1128}，\href{https://github.com/r00tk1ts}{r00tk1ts}，陈晓伟
		\\[8pt]
		\normalsize
		校对/整理；陈晓伟
	\end{center}
	...
	\textbf{David Vandevoorde}在20世纪80年代后期开始用C++编程。从伦斯勒理工学院获得博士学位后，成为惠普C++编译器团队的技术负责人。1999年，加入了爱迪生设计集团(EDG)，该集团的C++编译器技术是业界领先的。他是C++标准委员会的活跃成员，也是comp.lang.c++新闻组的主持人(他参与创办的)。也是《C++ Solutions》的作者，该书是《C++ Programming Language, 3rd Edition》配套书籍。
	
	\textbf{Nicolai M. Josuttis}因其畅销的事实上的标准书籍《The C++ Standard Library - A Tutorial and Reference》而闻名。他是一名独立技术顾问，为电信、交通、金融和制造业设计面向对象的软件。他是C++标准委员会的活跃成员，也是System Bauhaus的合伙人，System Bauhaus是一个由杰出的面向对象系统开发专家组成的德国团体。Josuttis还写过其他几本关于面向对象编程和C++的书。
	...
	\subsection*{\zihao{2} 第1章\hspace{0.5cm}Function Templates}
	\addcontentsline{toc}{subsection}{第1章\hspace{0.5cm}Function Templates}
	\subfile{content/1/chapter1/0.tex}
	
	\subsubsection*{\zihao{3} 1.1.\hspace{0.2cm}A First Look at Function Templates}
	\addcontentsline{toc}{subsubsection}{1.1.\hspace{0.2cm}A First Look at Function Templates}
	\subfile{content/1/chapter1/1.tex}
	
	\subsubsection*{\zihao{3} 1.2.\hspace{0.2cm}Template Argument Deduction}
	\addcontentsline{toc}{subsubsection}{1.2.\hspace{0.2cm}Template Argument Deduction}
	\subfile{content/1/chapter1/2.tex}
	
	\subsubsection*{\zihao{3} 1.3.\hspace{0.2cm}Multiple Template Parameters}
	\addcontentsline{toc}{subsubsection}{1.3.\hspace{0.2cm}Multiple Template Parameters}
	\subfile{content/1/chapter1/3.tex}
	
	\subsubsection*{\zihao{3} 1.4.\hspace{0.2cm}Default Template Arguments}
	\addcontentsline{toc}{subsubsection}{1.4.\hspace{0.2cm}Default Template Arguments}
	\subfile{content/1/chapter1/4.tex}
	
	\subsubsection*{\zihao{3} 1.5.\hspace{0.2cm}Overloading Function Templates}
	\addcontentsline{toc}{subsubsection}{1.5.\hspace{0.2cm}Overloading Function Templates}
	\subfile{content/1/chapter1/5.tex}
	
	\subsubsection*{\zihao{3} 1.6.\hspace{0.2cm}But, Shouldn’t We ...?}
	\addcontentsline{toc}{subsubsection}{1.6.\hspace{0.2cm}But, Shouldn’t We ...?}
	...
	\subsection*{\zihao{2} 第2章\hspace{0.5cm}Class Templates}
	\addcontentsline{toc}{subsection}{第2章\hspace{0.5cm}Class Templates}
	\subfile{content/1/chapter2/0.tex}
	
	\subsubsection*{\zihao{3} 2.1.\hspace{0.2cm}Implementation of Class Template Stack}
	\addcontentsline{toc}{subsubsection}{2.1.\hspace{0.2cm}Implementation of Class Template Stack}
	\subfile{content/1/chapter2/1.tex}
	
	\subsubsection*{\zihao{3} 2.2.\hspace{0.2cm}Use of Class Template Stack}
	\addcontentsline{toc}{subsubsection}{2.2.\hspace{0.2cm}Use of Class Template Stack}
	\subfile{content/1/chapter2/2.tex}
	
	\subsubsection*{\zihao{3} 2.3.\hspace{0.2cm}Partial Usage of Class Templates}
	\addcontentsline{toc}{subsubsection}{2.3.\hspace{0.2cm}Partial Usage of Class Templates}
	\subfile{content/1/chapter2/3.tex}
	
	\subsubsection*{\zihao{3} 2.4.\hspace{0.2cm}Friends}
	\addcontentsline{toc}{subsubsection}{2.4.\hspace{0.2cm}Friends}
	\subfile{content/1/chapter2/4.tex}
	
	\subsubsection*{\zihao{3} 2.5.\hspace{0.2cm}Specializations of Class Templates}
	\addcontentsline{toc}{subsubsection}{2.5.\hspace{0.2cm}Specializations of Class Templates}
	\subfile{content/1/chapter2/5.tex}
	
	\subsubsection*{\zihao{3} 2.6.\hspace{0.2cm}Partial Specialization}
	\addcontentsline{toc}{subsubsection}{2.6.\hspace{0.2cm}Partial Specialization}
	\subfile{content/1/chapter2/6.tex}
	
	\subsubsection*{\zihao{3} 2.7.\hspace{0.2cm}Default Class Template Arguments}
	\addcontentsline{toc}{subsubsection}{2.7.\hspace{0.2cm}Default Class Template Arguments}
	\subfile{content/1/chapter2/7.tex}
	
	\subsubsection*{\zihao{3} 2.8.\hspace{0.2cm}Type Aliases}
	\addcontentsline{toc}{subsubsection}{2.8.\hspace{0.2cm}Type Aliases}
	\subfile{content/1/chapter2/8.tex}
	
	\subsubsection*{\zihao{3} 2.9.\hspace{0.2cm}Class Template Argument Deduction}
	\addcontentsline{toc}{subsubsection}{2.9.\hspace{0.2cm}Class Template Argument Deduction}
	\subfile{content/1/chapter2/9.tex}
	
	\subsubsection*{\zihao{3} 2.10.\hspace{0.2cm}Templatized Aggregates}
	\addcontentsline{toc}{subsubsection}{2.10.\hspace{0.2cm}Templatized Aggregates}
	...
	\subsection*{\zihao{2} 第3章\hspace{0.5cm}Nontype Template Parameters}
	\addcontentsline{toc}{subsection}{第3章\hspace{0.5cm}Nontype Template Parameters}
	\subfile{content/1/chapter3/0.tex}
	
	\subsubsection*{\zihao{3} 3.1.\hspace{0.2cm}Nontype Class Template Parameters}
	\addcontentsline{toc}{subsubsection}{3.1.\hspace{0.2cm}Nontype Class Template Parameters}
	\subfile{content/1/chapter3/1.tex}
	
	\subsubsection*{\zihao{3} 3.2.\hspace{0.2cm}Nontype Function Template Parameters}
	\addcontentsline{toc}{subsubsection}{3.2.\hspace{0.2cm}Nontype Function Template Parameters}
	\subfile{content/1/chapter3/2.tex}
	
	\subsubsection*{\zihao{3} 3.3.\hspace{0.2cm}Restrictions for Nontype Template Parameters}
	\addcontentsline{toc}{subsubsection}{3.3.\hspace{0.2cm}Restrictions for Nontype Template Parameters}
	\subfile{content/1/chapter3/3.tex}
	
	\subsubsection*{\zihao{3} 3.4.\hspace{0.2cm}Template Parameter Type auto}
	\addcontentsline{toc}{subsubsection}{3.4.\hspace{0.2cm}Template Parameter Type auto}
	...
	\subsection*{\zihao{2} 第4章\hspace{0.5cm}Variadic Templates}
	\addcontentsline{toc}{subsection}{第4章\hspace{0.5cm}Variadic Templates}
	\subfile{content/1/chapter4/0.tex}
	
	\subsubsection*{\zihao{3} 4.1.\hspace{0.2cm}Variadic Templates}
	\addcontentsline{toc}{subsubsection}{4.1.\hspace{0.2cm}Variadic Templates}
	\subfile{content/1/chapter4/1.tex}
	
	\subsubsection*{\zihao{3} 4.2.\hspace{0.2cm}Fold Expressions}
	\addcontentsline{toc}{subsubsection}{4.2.\hspace{0.2cm}Fold Expressions}
	\subfile{content/1/chapter4/2.tex}
	
	\subsubsection*{\zihao{3} 4.3.\hspace{0.2cm}Application of Variadic Templates}
	\addcontentsline{toc}{subsubsection}{4.3.\hspace{0.2cm}Application of Variadic Templates}
	\subfile{content/1/chapter4/3.tex}
	
	\subsubsection*{\zihao{3} 4.4.\hspace{0.2cm}Variadic Class Templates and Variadic Expressions}
	\addcontentsline{toc}{subsubsection}{4.4.\hspace{0.2cm}Variadic Class Templates and Variadic Expressions}
	...
	\subsection*{\zihao{2} 第5章\hspace{0.5cm}Tricky Basics}
	\addcontentsline{toc}{subsection}{第5章\hspace{0.5cm}Tricky Basics}
	\subfile{content/1/chapter5/0.tex}
	
	\subsubsection*{\zihao{3} 5.1.\hspace{0.2cm}Keyword typename}
	\addcontentsline{toc}{subsubsection}{5.1.\hspace{0.2cm}Keyword typename}
	\subfile{content/1/chapter5/1.tex}
	
	\subsubsection*{\zihao{3} 5.2.\hspace{0.2cm}Zero Initialization}
	\addcontentsline{toc}{subsubsection}{5.2.\hspace{0.2cm}Zero Initialization}
	\subfile{content/1/chapter5/2.tex}
	
	\subsubsection*{\zihao{3} 5.3.\hspace{0.2cm}Using this->}
	\addcontentsline{toc}{subsubsection}{5.3.\hspace{0.2cm}Using this->}
	\subfile{content/1/chapter5/3.tex}
	
	\subsubsection*{\zihao{3} 5.4.\hspace{0.2cm}Templates for Raw Arrays and String Literals}
	\addcontentsline{toc}{subsubsection}{5.4.\hspace{0.2cm}Templates for Raw Arrays and String Literals}
	\subfile{content/1/chapter5/4.tex}
	
	\subsubsection*{\zihao{3} 5.5.\hspace{0.2cm}Member Templates}
	\addcontentsline{toc}{subsubsection}{5.5.\hspace{0.2cm}Member Templates}
	\subfile{content/1/chapter5/5.tex}
	
	\subsubsection*{\zihao{3} 5.6.\hspace{0.2cm}Variable Templates}
	\addcontentsline{toc}{subsubsection}{5.6.\hspace{0.2cm}Variable Templates}
	\subfile{content/1/chapter5/6.tex}
	
	\subsubsection*{\zihao{3} 5.7.\hspace{0.2cm}Template Template Parameters}
	\addcontentsline{toc}{subsubsection}{5.7.\hspace{0.2cm}Template Template Parameters}
	...
	\subsection*{\zihao{2} 第6章\hspace{0.5cm}Move Semantics and enable\_if<>}
	\addcontentsline{toc}{subsection}{第6章\hspace{0.5cm}Move Semantics and enable\_if<>}
	\subfile{content/1/chapter6/0.tex}
	
	\subsubsection*{\zihao{3} 6.1.\hspace{0.2cm}Perfect Forwarding}
	\addcontentsline{toc}{subsubsection}{6.1.\hspace{0.2cm}Perfect Forwarding}
	\subfile{content/1/chapter6/1.tex}
	
	\subsubsection*{\zihao{3} 6.2.\hspace{0.2cm}Special Member Function Templates}
	\addcontentsline{toc}{subsubsection}{6.2.\hspace{0.2cm}Special Member Function Templates}
	\subfile{content/1/chapter6/2.tex}
	
	\subsubsection*{\zihao{3} 6.3.\hspace{0.2cm}Disable Templates with enable\_if<>}
	\addcontentsline{toc}{subsubsection}{6.3.\hspace{0.2cm}Disable Templates with enable\_if<>}
	\subfile{content/1/chapter6/3.tex}
	
	\subsubsection*{\zihao{3} 6.4.\hspace{0.2cm}Using enable\_if<>}
	\addcontentsline{toc}{subsubsection}{6.4.\hspace{0.2cm}Using enable\_if<>}
	\subfile{content/1/chapter6/4.tex}
	
	\subsubsection*{\zihao{3} 6.5.\hspace{0.2cm}Using Concepts to Simplify enable\_if<> Expressions}
	\addcontentsline{toc}{subsubsection}{6.5.\hspace{0.2cm}Using Concepts to Simplify enable\_if<> Expressions}
	...
	\subsection*{\zihao{2} 第7章\hspace{0.5cm}By Value or by Reference?}
	\addcontentsline{toc}{subsection}{第7章\hspace{0.5cm}By Value or by Reference?}
	\subfile{content/1/chapter7/0.tex}
	
	\subsubsection*{\zihao{3} 7.1.\hspace{0.2cm}Passing by Value}
	\addcontentsline{toc}{subsubsection}{7.1.\hspace{0.2cm}Passing by Value}
	\subfile{content/1/chapter7/1.tex}
	
	\subsubsection*{\zihao{3} 7.2.\hspace{0.2cm}Passing by Reference}
	\addcontentsline{toc}{subsubsection}{7.2.\hspace{0.2cm}Passing by Reference}
	\subfile{content/1/chapter7/2.tex}
	
	\subsubsection*{\zihao{3} 7.3.\hspace{0.2cm}Using std::ref() and std::cref()}
	\addcontentsline{toc}{subsubsection}{7.3.\hspace{0.2cm}Using std::ref() and std::cref()}
	\subfile{content/1/chapter7/3.tex}
	
	\subsubsection*{\zihao{3} 7.4.\hspace{0.2cm}Dealing with String Literals and Raw Arrays}
	\addcontentsline{toc}{subsubsection}{7.4.\hspace{0.2cm}Dealing with String Literals and Raw Arrays}
	\subfile{content/1/chapter7/4.tex}
	
	\subsubsection*{\zihao{3} 7.5.\hspace{0.2cm}Dealing with Return Values}
	\addcontentsline{toc}{subsubsection}{7.5.\hspace{0.2cm}Dealing with Return Values}
	\subfile{content/1/chapter7/5.tex}
	
	\subsubsection*{\zihao{3} 7.6.\hspace{0.2cm}Recommended Template Parameter Declarations}
	\addcontentsline{toc}{subsubsection}{7.6.\hspace{0.2cm}Recommended Template Parameter Declarations}
	...
	\subsection*{\zihao{2} 第8章\hspace{0.5cm}Compile-Time Programming}
	\addcontentsline{toc}{subsection}{第8章\hspace{0.5cm}Compile-Time Programming}
	\subfile{content/1/chapter8/0.tex}
	
	\subsubsection*{\zihao{3} 8.1.\hspace{0.2cm}Template Metaprogramming}
	\addcontentsline{toc}{subsubsection}{8.1.\hspace{0.2cm}Template Metaprogramming}
	\subfile{content/1/chapter8/1.tex}
	
	\subsubsection*{\zihao{3} 8.2.\hspace{0.2cm}Computing with constexpr}
	\addcontentsline{toc}{subsubsection}{8.2.\hspace{0.2cm}Computing with constexpr}
	\subfile{content/1/chapter8/2.tex}
	
	\subsubsection*{\zihao{3} 8.3.\hspace{0.2cm}Execution Path Selection with Partial Specialization}
	\addcontentsline{toc}{subsubsection}{8.3.\hspace{0.2cm}Execution Path Selection with Partial Specialization}
	\subfile{content/1/chapter8/3.tex}
	
	\subsubsection*{\zihao{3} 8.4.\hspace{0.2cm}SFINAE (Substitution Failure Is Not An Error)}
	\addcontentsline{toc}{subsubsection}{8.4.\hspace{0.2cm}SFINAE (Substitution Failure Is Not An Error)}
	\subfile{content/1/chapter8/4.tex}
	
	\subsubsection*{\zihao{3} 8.5.\hspace{0.2cm}Compile-Time if}
	\addcontentsline{toc}{subsubsection}{8.5.\hspace{0.2cm}Compile-Time if}
	...
	\subsection*{\zihao{2} 第9章\hspace{0.5cm}Using Templates in Practice}
	\addcontentsline{toc}{subsection}{第9章\hspace{0.5cm}Using Templates in Practice}
	\subfile{content/1/chapter9/0.tex}
	
	\subsubsection*{\zihao{3} 9.1.\hspace{0.2cm}The Inclusion Model}
	\addcontentsline{toc}{subsubsection}{9.1.\hspace{0.2cm}The Inclusion Model}
	\subfile{content/1/chapter9/1.tex}
	
	\subsubsection*{\zihao{3} 9.2.\hspace{0.2cm}Templates and inline}
	\addcontentsline{toc}{subsubsection}{9.2.\hspace{0.2cm}Templates and inline}
	\subfile{content/1/chapter9/2.tex}
	
	\subsubsection*{\zihao{3} 9.3.\hspace{0.2cm}Precompiled Headers}
	\addcontentsline{toc}{subsubsection}{9.3.\hspace{0.2cm}Precompiled Headers}	
	\subfile{content/1/chapter9/3.tex}
	
	\subsubsection*{\zihao{3} 9.4.\hspace{0.2cm}Decoding the Error Novel}
	\addcontentsline{toc}{subsubsection}{9.4.\hspace{0.2cm}Decoding the Error Novel}
	\subfile{content/1/chapter9/4.tex}
	
	\subsubsection*{\zihao{3} 9.5.\hspace{0.2cm}Afternotes}
	\addcontentsline{toc}{subsubsection}{9.5.\hspace{0.2cm}Afternotes}
	...
	\subsection*{\zihao{2} 第10章\hspace{0.5cm}Basic Template Terminology}
	\addcontentsline{toc}{subsection}{第10章\hspace{0.5cm}Basic Template Terminology}
	\subfile{content/1/chapter10/0.tex}
	
	\subsubsection*{\zihao{3} 10.1.\hspace{0.2cm}“Class Template” or “Template Class”?}
	\addcontentsline{toc}{subsubsection}{10.1.\hspace{0.2cm}“Class Template” or “Template Class”?}
	\subfile{content/1/chapter10/1.tex}
	
	\subsubsection*{\zihao{3} 10.2.\hspace{0.2cm}Substitution, Instantiation, and Specialization}
	\addcontentsline{toc}{subsubsection}{10.2.\hspace{0.2cm}Substitution, Instantiation, and Specialization}
	\subfile{content/1/chapter10/2.tex}
	
	\subsubsection*{\zihao{3} 10.3.\hspace{0.2cm}Declarations versus Definitions}
	\addcontentsline{toc}{subsubsection}{10.3.\hspace{0.2cm}Declarations versus Definitions}
	\subfile{content/1/chapter10/3.tex}
	
	\subsubsection*{\zihao{3} 10.4.\hspace{0.2cm}The One-Definition Rule}
	\addcontentsline{toc}{subsubsection}{10.4.\hspace{0.2cm}The One-Definition Rule}
	\subfile{content/1/chapter10/4.tex}
	
	\subsubsection*{\zihao{3} 10.5.\hspace{0.2cm}Template Arguments versus Template Parameters}
	\addcontentsline{toc}{subsubsection}{10.5.\hspace{0.2cm}Template Arguments versus Template Parameters}
	...
	\subsection*{\zihao{2} 第11章\hspace{0.5cm}Generic Libraries}
	\addcontentsline{toc}{subsection}{第11章\hspace{0.5cm}Generic Libraries}
	\subfile{content/1/chapter11/0.tex}
	
	\subsubsection*{\zihao{3} 11.1.\hspace{0.2cm}Callables}
	\addcontentsline{toc}{subsubsection}{11.1.\hspace{0.2cm}Callables}
	\subfile{content/1/chapter11/1.tex}
	
	\subsubsection*{\zihao{3} 11.2.\hspace{0.2cm}Other Utilities to Implement Generic Libraries}
	\addcontentsline{toc}{subsubsection}{11.2.\hspace{0.2cm}Other Utilities to Implement Generic Libraries}
	\subfile{content/1/chapter11/2.tex}
	
	\subsubsection*{\zihao{3} 11.3.\hspace{0.2cm}Perfect Forwarding Temporaries}
	\addcontentsline{toc}{subsubsection}{11.3.\hspace{0.2cm}Perfect Forwarding Temporaries}
	\subfile{content/1/chapter11/3.tex}
	
	\subsubsection*{\zihao{3} 11.4.\hspace{0.2cm}References as Template Parameters}
	\addcontentsline{toc}{subsubsection}{11.4.\hspace{0.2cm}References as Template Parameters}
	\subfile{content/1/chapter11/4.tex}
	
	\subsubsection*{\zihao{3} 11.5.\hspace{0.2cm}Defer Evaluations}
	\addcontentsline{toc}{subsubsection}{11.5.\hspace{0.2cm}Defer Evaluations}
	\subfile{content/1/chapter11/5.tex}
	
	\subsubsection*{\zihao{3} 11.6.\hspace{0.2cm}Things to Consider When Writing Generic Libraries}
	\addcontentsline{toc}{subsubsection}{11.6.\hspace{0.2cm}Things to Consider When Writing Generic Libraries}
	...
	\color{white}
	\section*{\zihao{1}第二部分：Templates in Depth}
	\pagecolor{mygray}
	\addcontentsline{toc}{section}{第二部分：Templates in Depth}
	\textbf{\subfile{content/2/Section.tex}}
	\newpage
	\color{black}
	\pagecolor{white}
	
	\subsection*{\zihao{2} 第12章\hspace{0.5cm}Fundamentals in Depth}
	\addcontentsline{toc}{subsection}{第12章\hspace{0.5cm}Fundamentals in Depth}
	\subfile{content/2/chapter12/0.tex}
	
	\subsubsection*{\zihao{3} 12.1.\hspace{0.2cm}Parameterized Declarations}
	\addcontentsline{toc}{subsubsection}{12.1.\hspace{0.2cm}Parameterized Declarations}
	\subfile{content/2/chapter12/1.tex}
	
	\subsubsection*{\zihao{3} 12.2.\hspace{0.2cm}Template Parameters}
	\addcontentsline{toc}{subsubsection}{12.2.\hspace{0.2cm}Template Parameters}
	\subfile{content/2/chapter12/2.tex}
	
	\subsubsection*{\zihao{3} 12.3.\hspace{0.2cm}Template Arguments}
	\addcontentsline{toc}{subsubsection}{12.3.\hspace{0.2cm}Template Arguments}
	\subfile{content/2/chapter12/3.tex}
	
	\subsubsection*{\zihao{3} 12.4.\hspace{0.2cm}Variadic Templates}
	\addcontentsline{toc}{subsubsection}{12.4.\hspace{0.2cm}Variadic Templates}
	\subfile{content/2/chapter12/4.tex}
	
	\subsubsection*{\zihao{3} 12.5.\hspace{0.2cm}Friends}
	\addcontentsline{toc}{subsubsection}{12.5.\hspace{0.2cm}Friends}
	\subfile{content/2/chapter12/5.tex}
	
	\subsubsection*{\zihao{3} 12.6.\hspace{0.2cm}Afternotes}
	\addcontentsline{toc}{subsubsection}{12.6.\hspace{0.2cm}Afternotes}
	\subfile{content/2/chapter12/6.tex}
	\newpage
	
	\subsection*{\zihao{2} 第13章\hspace{0.5cm}Names in Templates}
	\addcontentsline{toc}{subsection}{第13章\hspace{0.5cm}Names in Templates}
	\subfile{content/2/chapter13/0.tex}
	
	\subsubsection*{\zihao{3} 13.1.\hspace{0.2cm}Name Taxonomy}
	\addcontentsline{toc}{subsubsection}{13.1.\hspace{0.2cm}Name Taxonomy}
	\subfile{content/2/chapter13/1.tex}
	
	\subsubsection*{\zihao{3} 13.2.\hspace{0.2cm}Looking Up Names}
	\addcontentsline{toc}{subsubsection}{13.2.\hspace{0.2cm}Looking Up Names}
	\subfile{content/2/chapter13/2.tex}
	
	\subsubsection*{\zihao{3} 13.3.\hspace{0.2cm}Parsing Templates}
	\addcontentsline{toc}{subsubsection}{13.3.\hspace{0.2cm}Parsing Templates}
	\subfile{content/2/chapter13/3.tex}
	
	\subsubsection*{\zihao{3} 13.4.\hspace{0.2cm}Inheritance and Class Templates}
	\addcontentsline{toc}{subsubsection}{13.4.\hspace{0.2cm}Inheritance and Class Templates}
	...
	\subsection*{\zihao{2} 第14章\hspace{0.5cm}Instantiation}
	\addcontentsline{toc}{subsection}{第14章\hspace{0.5cm}Instantiation}
	\subfile{content/2/chapter14/0.tex}
	
	\subsubsection*{\zihao{3} 14.1.\hspace{0.2cm}On-Demand Instantiation}
	\addcontentsline{toc}{subsubsection}{14.1.\hspace{0.2cm}On-Demand Instantiation}
	\subfile{content/2/chapter14/1.tex}
	
	\subsubsection*{\zihao{3} 14.2.\hspace{0.2cm}Lazy Instantiation}
	\addcontentsline{toc}{subsubsection}{14.2.\hspace{0.2cm}Lazy Instantiation}
	\subfile{content/2/chapter14/2.tex}
	
	\subsubsection*{\zihao{3} 14.3.\hspace{0.2cm}The C++ Instantiation Model}
	\addcontentsline{toc}{subsubsection}{14.3.\hspace{0.2cm}The C++ Instantiation Model}
	\subfile{content/2/chapter14/3.tex}
	
	\subsubsection*{\zihao{3} 14.4.\hspace{0.2cm}Implementation Schemes}
	\addcontentsline{toc}{subsubsection}{14.4.\hspace{0.2cm}Implementation Schemes}
	\subfile{content/2/chapter14/4.tex}
	
	\subsubsection*{\zihao{3} 14.5.\hspace{0.2cm}Explicit Instantiation}
	\addcontentsline{toc}{subsubsection}{14.5.\hspace{0.2cm}Explicit Instantiation}
	\subfile{content/2/chapter14/5.tex}
	
	\subsubsection*{\zihao{3} 14.6.\hspace{0.2cm}Compile-Time ifStatements}
	\addcontentsline{toc}{subsubsection}{14.6.\hspace{0.2cm}Compile-Time ifStatements}
	\subfile{content/2/chapter14/6.tex}
	
	\subsubsection*{\zihao{3} 14.7.\hspace{0.2cm}In the Standard Library}
	\addcontentsline{toc}{subsubsection}{14.7.\hspace{0.2cm}In the Standard Library}
	...
	\subsection*{\zihao{2} 第20章\hspace{0.5cm}Implementing Traits}
	\addcontentsline{toc}{subsection}{第20章\hspace{0.5cm}Implementing Traits}
	\subfile{content/3/chapter20/0.tex}
	
	\subsubsection*{\zihao{3} 20.1.\hspace{0.2cm}An Example: Accumulating a Sequence}
	\addcontentsline{toc}{subsubsection}{20.1.\hspace{0.2cm}An Example: Accumulating a Sequence}
	\subfile{content/3/chapter20/1.tex}
	
	\subsubsection*{\zihao{3} 20.2.\hspace{0.2cm}Traits versus Policies and Policy Classes}
	\addcontentsline{toc}{subsubsection}{20.2.\hspace{0.2cm}Traits versus Policies and Policy Classes}
	\subfile{content/3/chapter20/2.tex}
	
	\subsubsection*{\zihao{3} 20.3.\hspace{0.2cm}Type Functions}
	\addcontentsline{toc}{subsubsection}{20.3.\hspace{0.2cm}Type Functions}
	\subfile{content/3/chapter20/3.tex}
	
	\subsubsection*{\zihao{3} 20.4.\hspace{0.2cm}SFINAE-Based Traits}
	\addcontentsline{toc}{subsubsection}{20.4.\hspace{0.2cm}SFINAE-Based Traits}
	\subfile{content/3/chapter20/4.tex}
	
	\subsubsection*{\zihao{3} 20.5.\hspace{0.2cm}IsConvertibleT}
	\addcontentsline{toc}{subsubsection}{20.5.\hspace{0.2cm}IsConvertibleT}
	\subfile{content/3/chapter20/5.tex}
	
	\subsubsection*{\zihao{3} 20.6.\hspace{0.2cm}Detecting Members}
	\addcontentsline{toc}{subsubsection}{20.6.\hspace{0.2cm}Detecting Members}
	\subfile{content/3/chapter20/6.tex}
	
	\subsubsection*{\zihao{3} 20.7.\hspace{0.2cm}Other Traits Techniques}
	\addcontentsline{toc}{subsubsection}{20.7.\hspace{0.2cm}Other Traits Techniques}

...
\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
	...
	\subsection*{\zihao{2} 第24章\hspace{0.5cm}类型列表详述}
	\addcontentsline{toc}{subsection}{第24章\hspace{0.5cm}类型列表详述}
	\subfile{content/3/chapter24/0.tex}
	
	\subsubsection*{\zihao{3} 24.1.\hspace{0.2cm}解析类型列表}
	\addcontentsline{toc}{subsubsection}{24.1.\hspace{0.2cm}解析类型列表}
	\subfile{content/3/chapter24/1.tex}
	
	\subsubsection*{\zihao{3} 24.2.\hspace{0.2cm}类型列表算法}
	\addcontentsline{toc}{subsubsection}{24.2.\hspace{0.2cm}类型列表算法}
	\subfile{content/3/chapter24/2.tex}
	
	\subsubsection*{\zihao{3} 24.3.\hspace{0.2cm}非类型的类型列表}
	\addcontentsline{toc}{subsubsection}{24.3.\hspace{0.2cm}非类型的类型列表}
	...
	\subsubsection*{\zihao{3} 24.5.\hspace{0.2cm}Cons风格的类型列表}
	\addcontentsline{toc}{subsubsection}{24.5.\hspace{0.2cm}Cons风格的类型列表}

...
\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
	...
	\subsection*{\zihao{2} 第19章\hspace{0.5cm}Trait的实现}
	\addcontentsline{toc}{subsection}{第19章\hspace{0.5cm}Trait的实现}
	...
	\subsubsection*{\zihao{3} 19.2.\hspace{0.2cm}Traits、Policy和Policy类}
	\addcontentsline{toc}{subsubsection}{19.2.\hspace{0.2cm}Traits、Policy和Policy类}
	...
	\subsubsection*{\zihao{3} 19.4.\hspace{0.2cm}基于SFINAE的Trait}
	\addcontentsline{toc}{subsubsection}{19.4.\hspace{0.2cm}基于SFINAE的Trait}
	...
	\subsubsection*{\zihao{3} 19.7.\hspace{0.2cm}其他Trait技术}
	\addcontentsline{toc}{subsubsection}{19.7.\hspace{0.2cm}其他Trait技术}
